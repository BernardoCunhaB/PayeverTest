...
public class FashionPage {
    ...
    By companyNameField = By.xpath("//input[@formcontrolname = 'name']");
    ...
    By iconProducts = By.xpath("//div[contains(@class, 'icons__title') and text()='Products']");
    By iconShop = By.xpath("//div[contains(@class, 'icons__title') and text()='Shop']");
    By iconMessage = By.xpath("//div[contains(@class, 'icons__title') and text()='Message']");
   ...
   public void singUp (){
    ...
    public void Products(){
        try {
            WebElement element = driver.findElement(iconProducts);
            if (element.isDisplayed()) {
                System.out.println("The Products icon exists on the panel!");
            }
        } catch (NoSuchElementException e) {
            System.out.println("The Products icon was not found on the panel!");
        }
    }

    public void Shop(){
        try {
            WebElement element = driver.findElement(iconShop);
            if (element.isDisplayed()) {
                System.out.println("The Shop icon exists on the panel!");
            }
        } catch (NoSuchElementException e) {
            System.out.println("The Shop icon was not found on the panel!");
        }
    }

    public void Message(){
        try {
            WebElement element = driver.findElement(iconMessage);
            if (element.isDisplayed()) {
                System.out.println("The Message icon exists on the panel!");
            }
        } catch (NoSuchElementException e) {
            System.out.println("The Message icon was not found on the panel!");
        }
    }
